...
public class Inventory {
    ...
    private final List<GameItem> items = new ArrayList<>();  // list of carried items
     ...
     */
    public Optional<GameItem> removeItem(String name) {
        Optional<GameItem> found = items.stream()
